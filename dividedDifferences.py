...
print(f"The interpolated polynomial of SN1 at T = {target_x} is {result:.6f}")
...
print(f"The interpolated polynomial of SN2 at T = {target_x} is {result:.6f}")
...
print(f"The interpolated polynomial of SN3 at T = {target_x} is {result:.6f}")
