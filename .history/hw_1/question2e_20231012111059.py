...
a, b = 0, 2
n = 9 # Initial number of intervals
...
if integral_approximation - target < target_accuracy:
    print("Found integral within the target accuracy with", n, "intervals")
else:
    print("Failed: Found integral outside target accuracy with", n, "intervals")
